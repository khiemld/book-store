                        ...
                        <div class="card info-card sales-card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ps-3">
                                        <h6>${deliveryList.size()} phương thức</h6>
                                ...
                                <table class="table table-borderless datatable">
                                    ...
                                    <c:forEach items="${deliveryList}" var="d">
                                        <tr>
                                            ...
                                            <td class="desciption-column-witdh"><a href="">${d.name}</a></td>
                                            <td>${d.shipFee}</td>
                                            <td class="action-column">
                                                <a href="${pageContext.request.contextPath}/admin/delivery?action=edit&deliveryID=${d.id}"
                                                   class="btn btn-outline-primary full-column-width  margin-top-10">Chi
                                                    tiết</a>
                                                <form action="" method="post">
                                                    ...
                                                    <input class="btn btn-danger margin-top-10 full-column-width"
                                                           type="submit"
                                                           value="Xóa"
                                                           onclick="if (confirm('Bạn có chắc chắn muốn xóa phương thức này này (không thể khôi phục)?')) { form.action='${pageContext.request.contextPath}/admin/delivery'; } else { return false; }"/>
                                                </form>
                                            </td>
                                        </tr>
                                    </c:forEach>
