        ...
        <div class="row">
            ...
            <div class="col-lg-8 recent-sales">
                <div class="row">
                    ...
                    <form action="${pageContext.request.contextPath}/admin/paymethod" method="post">
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <a href="${pageContext.request.contextPath}/admin/paymethod" class="btn ${action.equals("insert")?"btn-danger":"btn-success"}">${action.equals("insert")?"Cancel":"OK"}</a>
